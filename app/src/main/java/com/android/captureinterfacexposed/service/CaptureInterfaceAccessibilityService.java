...
public class CaptureInterfaceAccessibilityService extends AccessibilityService {
    ...
    public JSONObject accessibilityNodeInfoToJson(AccessibilityNodeInfo node) throws JSONException {
        ...
        jsonObject.put("canScroll", node.isScrollable());
        jsonObject.put("isClickable", node.isClickable());
        jsonObject.put("isLongClickable", node.isLongClickable());
        jsonObject.put("isFocusable", node.isFocusable());
        jsonObject.put("isFocused", node.isFocused());
        jsonObject.put("isVisibleToUser",node.isVisibleToUser());
        jsonObject.put("isSelected", node.isSelected());
